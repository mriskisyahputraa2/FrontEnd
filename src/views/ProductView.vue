              ...
              <div class="col-lg-6">
                ...
                <div class="product-thumbs">
                  <carousel class="product-thumbs-track ps-slider" :nav="false" :dots="false">
                    ...
                    >
                      <!-- jika class thumbs sesuai dengan gambar_default maka, gambar akan active sesuai dgn yang di click-->
...
import ReletedStore from "@/components/ReletedStore.vue";
...
export default {
  ...
  methods: {
    // membuat events pada gambar, saat di klick active
